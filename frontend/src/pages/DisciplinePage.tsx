...
export const DisciplinePage = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            setOriginalData(disciplines);
            setFilteredData(disciplines);
        }
        catch (err) {
    ...
    const handleFilterSubmit = (filterBy: string, filterValue: string) => {
        const key = filterBy as keyof DisciplineDTO; 
    ...
    return (
        <div className={styles.page}>
            ...
            <Modal isOpen={activeModal === 'create'} onClose={closeModal} title="Create Discipline"><DisciplineForm onSuccess={handleSuccess} /></Modal>
            <Modal isOpen={activeModal === 'read'} onClose={closeModal} title={`Details for Discipline #${selectedRow?.id}`}><DisciplineDetails itemData={selectedRow} /></Modal>
            <Modal isOpen={activeModal === 'update'} onClose={closeModal} title={`Update Discipline #${selectedRow?.id}`}><DisciplineForm onSuccess={handleSuccess} initialData={selectedRow} /></Modal>
